    ...
    $.fn.selectHierarchy = function(options) {        
        ...
        var change_handler = function(){
            ...
            if (node && node.children.length > 0) {
                this_select.after('<select name="' + options.name + '1" id="' + options.name + '1" required ><option value="">' + options.placeholder + '</option></select>'); //<div class="dropbox"><label>' + options.title + '*</label><br /></div>
