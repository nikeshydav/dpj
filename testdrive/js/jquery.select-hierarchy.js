...
(function($){
    $.fn.selectHierarchy = function(options) {        
        ...
        obj.after('<select class="drilldown-1" name="' + options.name + '" id="' + options.name + '" required ><option value=""> ' + options.placeholder + ' </option></select>');
        ...
        var change_handler = function(){
            ...
            if (node && node.children.length > 0) {
                this_select.after('<select name="' + options.name + '1" id="' + options.name + '1" required ><option value="">' + options.placeholder1 + '</option></select>'); //<div class="dropbox"><label>' + options.title + '*</label><br /></div>
